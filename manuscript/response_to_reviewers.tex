...
Direct DFT calculations instead delimit the supported adsorption and force-
transferability conclusions and identify targeted future labels.

\changes Introduction, p.~2, lines 46--53; new references 14 and 15, p.~13,
lines 387--391. A six-row comparison of model, exploration, selection signal,
...
p.~2, lines 46--53; scientific question and result, pp.~2--3, lines 54--68.
...
\changes MACE potential development and validation, pp.~5--6, lines
...
\changes Correlation-controlled split and its limitation, p.~5, lines 132--142;
benchmark selection and DFT protocol, p.~6, lines 173--184; new balanced-force
results in Figure~2 (p.~8) and Results and Discussion, pp.~9--10, lines
250--275; detailed frame-level values in Supporting Information Table~4 (p.~3).
The correlated-split
...
\changes Methods, p.~4, lines 114--129; Scope and limitations, p.~11, lines
305--310; Supporting Information Figure~3 and Table~5 (p.~5); curated file
...
\changes Finite-temperature snapshot generation, p.~7, lines 185--205,
especially lines 191--193. The trajectory traces and their seed dependence are
...
\changes Abstract, p.~1, lines 19--27; Figure~2, p.~8; balanced and
environment-resolved DFT results, pp.~9--10, lines 250--299; Conclusion,
p.~11, lines 311--327.
...
\changes Methods, p.~7, lines 200--205; Results, p.~10, lines 291--299.
...
30--68; Results and Discussion, pp.~9--11, lines 236--310; Conclusion, p.~11,
lines 311--327.
...
\changes Dataset scope, p.~4, lines 121--131; correlation-controlled split,
p.~5, lines 132--142; architecture and training protocol, pp.~5--6, lines
143--172; balanced-test protocol, p.~6, lines 173--184; snapshot validation
protocol, p.~7, lines 185--205; Supporting Information Tables~1--2 (p.~2).
