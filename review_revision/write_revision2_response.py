...
def main() -> None:
    ...
    responses = [
        ...
        ("Grammar, syntax, and academic language",
         ...
         "the DFT and MACE approach, the principal adsorption and force findings, and "
         "their implications for potential development. Detailed numerical diagnostics "
         "are presented in the Results. The architecture description now explains the "
         "scalar and vector feature channels separately from the angular basis. "
         "We removed repetitive statements about the "
        ...
        ("Equation and symbol rendering",
         ...
         "squared-length units use siunitx in math mode, with the complete negative "
         "exponent raised above the baseline. Mesh dimensions use a single math "
