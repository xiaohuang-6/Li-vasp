...
The conclusion now states that the defensible claim is local adsorption-energy screening plus target-domain MACE diagnostics, not quantitative lithium diffusion or practical anode performance prediction.

## Comment 7: Reproducibility

We expanded the workflow documentation and generated reproducibility materials for the revision. The project now contains VASP preparation scripts, MACE evaluation scripts, committee training scripts, LAMMPS unwrapped-MD inputs, analysis scripts, processed CSV files, generated figures, status summaries, an MIT license, and a reproducibility archive manifest. The revised manuscript includes a Data and Code Availability section that states the planned versioned archive/DOI, tag, license, included materials, and exclusions for licensed or large VASP runtime files.
