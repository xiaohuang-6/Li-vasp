...
\section{PBE-D3(BJ) multi-site adsorption checks}
...
\begin{table}[H]
  ...
  prespecified PBE-ranked placements in each family. More negative values
...
\section{Prespecified family-balanced force benchmark}
...
\begin{table}[H]
  \centering
  \caption{Direct DFT force benchmark on five prespecified perturbations per
...
fine-tuning benefits the prespecified local perturbations beyond the
five-configuration grouped-split audit. The remaining family force errors of
