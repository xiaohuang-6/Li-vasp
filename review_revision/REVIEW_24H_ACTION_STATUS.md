...
Latest production-snapshot collector status at 14:09 EDT on 2026-07-26:
...
- Production-set high-displacement DFT snapshots: 7/7 completed and
  electronically converged with ASE-readable forces. The accepted rows contain
  five snapshots from two reference-model trajectories and two snapshots from
  one committee-model trajectory, spanning 57.0--500.0 ps.
